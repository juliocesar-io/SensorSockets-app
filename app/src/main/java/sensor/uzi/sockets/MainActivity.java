...
public class MainActivity extends Activity implements BluetoothAdapter.LeScanCallback {
    ...
    private static final UUID AMB_TEMP_DATA_CHAR = fromString("f000aa01-0451-4000-b000-000000000000");
    private static final UUID AMB_TEMP_CONFIG_CHAR = fromString("f000aa02-0451-4000-b000-000000000000");
    /* Client Configuration Descriptor */
    private static final UUID CONFIG_DESCRIPTOR = UUID.fromString("00002902-0000-1000-8000-00805f9b34fb");
    public static double JAJA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /* Excecute the Thread for sent data to server*/
       /* SocketStream ConnectToNodejs = new SocketStream();
        ConnectToNodejs.execute();*/
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        for (int i=0; i < mDevices.size(); i++) {
            ...
            menu.add(0, mDevices.keyAt(i), 0, "SensorTag");
        }
    ...
    private BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        private void enableNextSensor(BluetoothGatt gatt) {
            ...
            switch (mState) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    Log.d(TAG, "Enabling IRTemp");
                    characteristic = gatt.getService(AMB_TEMP_SERVICE)
                            .getCharacteristic(AMB_TEMP_CONFIG_CHAR);
                    characteristic.setValue(new byte[] {0x01});
                    break;
        ...
        private void readNextSensor(BluetoothGatt gatt) {
            ...
            switch (mState) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    Log.d(TAG, "Reading ir temp");
                    characteristic = gatt.getService(AMB_TEMP_SERVICE)
                            .getCharacteristic(AMB_TEMP_DATA_CHAR);
                    break;
                default:
                    mHandler.sendEmptyMessage(MSG_DISMISS);
                    Log.i(TAG, "All Sensors Enabled");
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS && newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                mHandler.sendMessage(Message.obtain(null, MSG_PROGRESS, "Decodificando servicios..."));
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            ...
            mHandler.sendMessage(Message.obtain(null, MSG_PROGRESS, "Activando Sensores..."));
            /*
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            if (AMB_TEMP_DATA_CHAR.equals(characteristic.getUuid())) {
                mHandler.sendMessage(Message.obtain(null, MSG_AMB_TEMP, characteristic));
            }
    ...
    private static final int MSG_AMB_TEMP = 104;
